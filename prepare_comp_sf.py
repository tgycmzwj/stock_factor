...
def prepare_comp_sf(conn,cursor,queries,freq="m"):
    ...
    #query5
    util_funcs.create_index(table_name='comp_secd',index_name='idx',column_name='gvkey,datadate')
    util_funcs.create_index(table_name='__firm_shares2',index_name='idx',column_name='gvkey,ddate')
